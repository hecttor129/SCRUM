...
namespace DAL
{
    public class DB_Context : DbContext
    {
        ...
        public DbSet<AnalisisTecnico> AnalisisTecnicos { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Tarea>(entity =>
            {
                ...
                entity.HasOne<AnalisisTecnico>()
                      .WithMany()
                      .HasForeignKey(e => e.IdAnalisis)
                      .IsRequired(false);
            ...
            {
                entity.ToTable("ANALISIS_TECNICOS");
                ...
                entity.Property(e => e.TareasGeneradas)
                      .HasColumnName("TAREAS_GENERADAS")
                      .HasColumnType("text")
                      .IsRequired(false);

                entity.Property(e => e.FechaGeneracionTareas)
                      .HasColumnName("FECHA_GENERACION_TAREAS")
                      .IsRequired(false);
